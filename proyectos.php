            ...
            <div class="col-12 d-flex align-content-stretch flex-wrap">
                <div class="col-sm-4 col-12">
                    <div class="card shadow-lg m-1">
                        <img src="images/clientes.png" alt="ABM Clientes" title="ABM Clientes" class="img img-fluid">
                ...
                <div class="col-sm-4 col-12">
                    <div class="card shadow-lg m-1" >
                        <img src="images/svg.png" alt="Sistema de Gestión de Ventas" title="Sistema de Gestión de Ventas" class="img img-fluid">
                        <div class="col-12 color-gradiente py-3">
                ...
                <div class="col-sm-4 col-12">
                    <div class="card shadow-lg m-1">
                        <img src="images/proyectoIntegrador.png" alt="Proyecto" title="Proyecto Integrador" class="img img-fluid">
                        <div class="col-12 color-gradiente py-3">
